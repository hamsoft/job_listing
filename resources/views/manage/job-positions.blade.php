    ...
    <div>
        ...
        <table id="job_positions" class="table table-hover table-bordered table-striped  table-sm">
            ...
            <tr>
                ...
                <th class="bg-dark" style="width: 130px;" scope="col">Status</th>
                <th class="bg-dark" style="width: 130px;" scope="col">Candidates</th>
...
@section('scripts')
    ...
    <script>
        ...
        function loadPositions() {
            $.getJSON('{{route('api.manage.job-positions')}}', function (data) {
                ...
                for (var i in data) {
                    ...
                    var row = '<tr>' +
                        '<th>' + (parseInt(i) + 1) + '</th>' +
                        '<td>' + job.name + '</td>' +
                        '<td>' + jobPositionStatuses[job.status] + '</td>' +
                        '<td>10</td>' +
                        '<td>' + job.deadline + '</td>' +
